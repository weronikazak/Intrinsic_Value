...
def get_income_statement_ahead(net_income_margins, median_growth, median_FFCE):
...
def get_terminal_value(i, income_statement_numbers):
...
def get_discount_factors(income_statement_numbers):
